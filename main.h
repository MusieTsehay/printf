...
void print_percent(va_list *args_list, fmt_info_t *fmt_info);
void print_p(va_list *args_list, fmt_info_t *fmt_info);
void print_c(va_list *args_list, fmt_info_t *fmt_info);
void print_s(va_list *args_list, fmt_info_t *fmt_info);

void print_di(va_list *args_list, fmt_info_t *fmt_info);
void print_xX(va_list *args_list, fmt_info_t *fmt_info);
void print_o(va_list *args_list, fmt_info_t *fmt_info);
void print_u(va_list *args_list, fmt_info_t *fmt_info);

void print_b(va_list *args_list, fmt_info_t *fmt_info);
void print_R(va_list *args_list, fmt_info_t *fmt_info);
void print_r(va_list *args_list, fmt_info_t *fmt_info);
void print_S(va_list *args_list, fmt_info_t *fmt_info);

void print_fF(va_list *args_list, fmt_info_t *fmt_info);
